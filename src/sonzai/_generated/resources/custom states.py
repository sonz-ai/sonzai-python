...
"""Auto-generated resource classes for the Custom states tag."""
...
class _Custom statesBase:
    def __init__(self, http: Any) -> None:
        self._http = http


class Custom states(_Custom statesBase):
...
class AsyncCustom states(_Custom statesBase):
