...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/storefront/agents/{agent_id}".format(agent_id=quote(str(agent_id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """ Remove an agent from the storefront
     ...
     Removes the agent from the storefront. The agent itself is unaffected; only its storefront placement
    is removed.
