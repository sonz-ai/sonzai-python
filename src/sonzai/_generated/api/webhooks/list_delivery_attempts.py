...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/projects/{project_id}/webhooks/{event_type}/attempts".format(project_id=quote(str(project_id), safe=""),event_type=quote(str(event_type), safe=""),),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """ List webhook delivery attempts
     ...
     Returns recent delivery attempts for a specific webhook event type, with pagination support.
