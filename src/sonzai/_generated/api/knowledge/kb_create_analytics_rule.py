...
from ...models.kb_create_analytics_rule_input_body import KbCreateAnalyticsRuleInputBody
...
def _get_kwargs(
    project_id: str,
    *,
    body: KbCreateAnalyticsRuleInputBody,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/projects/{project_id}/knowledge/analytics/rules".format(project_id=quote(str(project_id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """ Create an analytics rule
     ...
     Creates a recommendation or trend analytics rule for the knowledge base.
