...
def sync_detailed(
    *,
    ...
    """ Workbench chat (SSE streaming)
     ...
     Streams chat with the same pipeline as production /chat but with inspector-level trace events
    interleaved on the stream. TODO: typed chunk schema + SDK polish.
