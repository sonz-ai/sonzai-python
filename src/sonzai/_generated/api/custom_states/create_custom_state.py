...
from ...models.create_custom_state_input_body import CreateCustomStateInputBody
...
def _get_kwargs(
    agent_id: str,
    *,
    body: CreateCustomStateInputBody,
...
def sync_detailed(
    ...
    *,
    ...
    """ Create a custom state
     ...
     Creates a new custom state for the given agent. Scope defaults to `global` and content_type defaults
    to `text`.
