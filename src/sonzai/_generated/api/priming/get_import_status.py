...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/agents/{agent_id}/users/import/{job_id}".format(agent_id=quote(str(agent_id), safe=""),job_id=quote(str(job_id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """ Get batch import job status
     ...
     Returns the current status of a batch user import job.
