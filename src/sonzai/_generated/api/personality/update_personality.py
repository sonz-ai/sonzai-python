...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> ErrorModel | UpdatePersonalityOutputBody:
    if response.status_code == 200:
        response_200 = UpdatePersonalityOutputBody.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[ErrorModel | UpdatePersonalityOutputBody]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorModel | UpdatePersonalityOutputBody
     """
