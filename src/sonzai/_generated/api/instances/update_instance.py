...
from ...models.update_instance_input_body import UpdateInstanceInputBody
...
def sync_detailed(
    ...
    *,
    ...
    """ Update an instance
     ...
     Partially updates an agent instance (name, description, status).
