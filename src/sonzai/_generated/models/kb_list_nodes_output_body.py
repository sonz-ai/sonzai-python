...
T = TypeVar("T", bound="KbListNodesOutputBody")



@_attrs_define
class KbListNodesOutputBody:
    """ 
        Attributes:
            nodes (list[KBNode] | None): List of active nodes
            total (int): Total active count (before pagination)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        kb_list_nodes_output_body = cls(
            nodes=nodes,
            total=total,
            schema=schema,
        )

        return kb_list_nodes_output_body
