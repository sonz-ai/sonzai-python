...
T = TypeVar("T", bound="CreateAgentBodyBehaviorsStruct")



@_attrs_define
class CreateAgentBodyBehaviorsStruct:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_agent_body_behaviors_struct = cls(
            conflict_approach=conflict_approach,
            empathy_style=empathy_style,
            question_frequency=question_frequency,
            response_length=response_length,
        ...
        return create_agent_body_behaviors_struct
