...
if TYPE_CHECKING:
  from ..models.kb_node_properties import KBNodeProperties
  from ..models.kb_node_property_sources import KBNodePropertySources





T = TypeVar("T", bound="KBNode")
...
class KBNode:
    """ 
        Attributes:
            ...
            norm_label (str):
            project_id (str):
            properties (KBNodeProperties):
            source_docs (list[str] | None):
            source_type (str):
            updated_at (datetime.datetime):
            version (int):
            schema (str | Unset): A URL to the JSON Schema for this object.
            property_sources (KBNodePropertySources | Unset):
            scope_id (str | Unset):
            tenant_id (str | Unset):
     """
    ...
    property_sources: KBNodePropertySources | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        properties = KBNodeProperties.from_dict(d.pop("properties"))
        ...
        if isinstance(_property_sources,  Unset):
            ...
            property_sources = KBNodePropertySources.from_dict(_property_sources)
