...
T = TypeVar("T", bound="SeedGeneratedMemory")



@_attrs_define
class SeedGeneratedMemory:
    """ 
        Attributes:
            content (str): Memory content text
            fact_type (str): Type of fact
            importance (float): Importance score
            entities (list[str] | None | Unset): Related entities
     """
