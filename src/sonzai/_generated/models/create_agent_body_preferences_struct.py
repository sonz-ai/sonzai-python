...
T = TypeVar("T", bound="CreateAgentBodyPreferencesStruct")



@_attrs_define
class CreateAgentBodyPreferencesStruct:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_agent_body_preferences_struct = cls(
            conversation_pace=conversation_pace,
            emotional_expression=emotional_expression,
            formality=formality,
            humor_style=humor_style,
        ...
        return create_agent_body_preferences_struct
